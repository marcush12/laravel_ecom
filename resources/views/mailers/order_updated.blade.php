                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Novo Status do Pedido</h1>
                                                                <strong>Hi! {{$order->email}}</strong>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Se algum dado estiver errado</h1>
                                                                <a href="#">mande um email para nós: tony@commerce.com</a>
                                                            </div>
														</td>
                                                    </tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/order/'. $order->shoppingCartID() )}}" target="_blank">Ver pedido na internet</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; *|2018|* *|Annette's|*, All rights reserved.</em>
																<br />
