                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Recibo do Pagamento a Annette's</h1>
                                                                <strong>Olá! {{$order->email}}</strong> Enviamos a você os dados referentes à sua compra junto a Annette's.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/order/'. $order->shoppingCartID() )}}" target="_blank">Watch Order on Website</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
